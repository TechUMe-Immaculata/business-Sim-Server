...
var feed2 = "The new leader in the indrustry is" + cat.get("companyName") + "." + "They made $" + cat.get("stats").revenue+ "revenue. The market seems to love thier price point of $" + cat.get("price");
