...
Parse.Cloud.define("turn", function(request, response)
{
	...
	}).then(function(compMatch)
	{
		...
		for (var i = 0; i < compMatch.length; i++)
		{
			...
			//define variables
			var maxProduction = 0;
			const PRICE_INCREMENT_PER_PRODUCT = 50,
				INITIAL_PRODUCTION = 150;
...
Parse.Cloud.define("createMatch_Multi_Ready", function(request, response)
{
	//define variables
	var matchId = request.params.matchId;
